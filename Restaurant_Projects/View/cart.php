...
<body>
  <nav class="dashboard">
    ...
    <div class="menu">
      ...
      <a style="background-color: #3b82f6"  href="./cart.php" class="active user-only">
  ...
  <main class="main-dashboard">
    ...
    <main class="page">
          ...
          <tbody>
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td>
                            <button class = 'btnDelete' onclick='deleteProduct(" . $row["ID"] . ")'>
      ...
      <div class="box-dashboard">
        ...
        <!-- Thêm lựa chọn đơn vị giao hàng -->
        <div class="box-dashboard-row"> 
          <p class="title-row ">Chọn đơn vị giao hàng</p>
          <div style="display: flex;  align-items: center;">
            <select class="shipping" id="shippingCompany" name="shippingCompany">
                <option value="">Chọn đơn vị giao hàng 
                  
                </option>
                <option value="GrabFood">GrabFood</option>
                <option value="BeeFood">BeeFood</option>
            </select>
            <button class="btn-apdung-giaohang">Áp dụng</button>
          </div>   
        </div>
        <div id="selectedShipping"></div>
...
// Xử lý sự kiện chọn đơn vị giao hàng
document.querySelector('.btn-apdung-giaohang').addEventListener('click', function() {
    var shippingCompany = document.querySelector('.shipping').value;
    var shippingDisplay = document.getElementById('selectedShipping');
    
    if (shippingCompany) {
        var shippingImage = '';
        if (shippingCompany === 'GrabFood') {
            shippingImage = '../assets/shipper/grabfood.png';
        } else if (shippingCompany === 'BeeFood') {
            shippingImage = '../assets/shipper/beefood.png';
        }

        shippingDisplay.innerHTML = '<br><img src="' + shippingImage + '" alt="' + shippingCompany + '" width="100" height="100">';
    } else {
