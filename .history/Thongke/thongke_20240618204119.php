...
<html lang="en">
      ...
      <main class="page">
        <div class="container">
          ...
          <div class="stats">
            ...
            <div class="stat">
              <h2 id="totalUsers1" class="stat-number">0</h2>
              <p class="stat-label">Tổng số người dùng</p>
            </div>
            <div class="stat">
              <h2 id="totalUsers2" class="stat-number">0</h2>
              <p class="stat-label">Tổng số đơn hàng</p>
            </div>
            <div class="stat">
              <h2 id="totalUsers3" class="stat-number">0</h2>
              <p class="stat-label">Tổng số người dùng</p>
            </div>
            <div class="stat">
              <h2 id="totalUsers4" class="stat-number">0</h2>
              <p class="stat-label">Tổng số người dùng</p>
            </div>
            <div class="stat">
              <h2 id="totalUsers5" class="stat-number">0</h2>
              <p class="stat-label">Tổng số người dùng</p>
            </div>
          </div>
        </div>
  ...
  <script>
    ...
    document.addEventListener('DOMContentLoaded', () => {
      ...
      // Giả sử bạn có các giá trị này từ một API hoặc cơ sở dữ liệu
      const totalProducts = 120; // Ví dụ: lấy từ API
      const totalUsers = 300; // Ví dụ: lấy từ API

      // Cập nhật các giá trị trên giao diện
      document.getElementById('totalProducts').textContent = totalProducts;
      document.getElementById('totalUsers1').textContent = totalUsers;
      document.getElementById('totalUsers2').textContent = totalUsers;
      document.getElementById('totalUsers3').textContent = totalUsers;
      document.getElementById('totalUsers4').textContent = totalUsers;
      document.getElementById('totalUsers5').textContent = totalUsers;
    });
  </script>
</html>
