...
.pagination a.active {
  ...
  <body>
    ...
    <main class="main-dashboard">
      ...
      <thead>
        <tr>
                <th scope="col" onclick="sortTable(1, true, true)">ID &#x2191;</th>
                ...
                <th scope="col" onclick="sortTable(4, true, true)">Role&#x2191;</th>
    ...
    if ($result->num_rows > 0) {
      ...
      while ($row = $result->fetch_assoc()) {
          ...
          echo "<td>" . $row["Role"] . "</td>";
          echo "<td>
                  <button class='btn update-btn' onclick='updateProduct(" . $row["ID"] . ")'>Đang kích hoạt</button>
                </td>";
          echo "</tr>";
      }
  } else {
