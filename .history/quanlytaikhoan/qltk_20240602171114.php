    ...
    .then(data => {
        if (data.success) {
            ...
            if (button.innerText = 'Không kích hoạt') {
                ...
                button.style.backgroundColor = '#f44336 !important'; // Thay đổi màu nền của nút khi chữ là "Không kích hoạt"
            } else {
                button.innerText = 'Đang kích hoạt';
                button.style.backgroundColor = ''; // Đặt lại màu nền mặc định
            }
        } else {
