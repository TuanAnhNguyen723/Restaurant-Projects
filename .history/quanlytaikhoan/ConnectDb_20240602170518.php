...
//
    ...
    $sql = "SELECT Username, Email, Phone, HoTen, Active FROM account WHERE ID='$user_id'"; 
...
$sql = "SELECT ID, Username, Email, Phone, HoTen, Active Role FROM account LIMIT $offset, $items_per_page";
$result = $conn->query($sql);
