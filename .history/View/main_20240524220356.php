    ...
    <div id="page" class="site">
      <header>
        <div class="container">
          <nav>
            <div class="left">
              <div class="logo"><a href="#">Restaurant Web Food</a></div>
              <div class="menu">
                <ul>
                  <li><a href="#home">Home</a></li>
                  <li><a href="#categori">Menu</a></li>
            ...
            <div class="right">
              <div class="icons">
                <a href="#" class="icart">
                  ...
                  <span id="count" class="number">0</span>
                </a>
      ...
      <main class = "main_login">
        <div id="home" class="hero">
          <div class="container">
            <h1>Don't wait to feel hungry</h1>
            <span class="text">Coocked by best chef</span>
            <div class="slider">
              ...
              <div thumbSlider="" class="thumb-nav swiper">
                <ul class="swiper-wrapper">
                  <li class="swiper-slide">
                    <div class="item">
                      <h4>Breakfast Food <br /><span>half boiled egg</span></h4>
                      <div class="thumbnail">
                        <img src="../assets/slider/food1.png" alt="" />
                      </div>
                    </div>
                  ...
                  <li class="swiper-slide">
                    <div class="item">
                      <h4>Lunch Food <br /><span>boiled beans</span></h4>
                      <div class="thumbnail">
                        <img src="../assets/slider/food2.png" alt="" />
                      </div>
                    </div>
                  ...
                  <li class="swiper-slide">
                    <div class="item">
                      <h4>Dinner Food <br /><span>good to know this</span></h4>
                      <div class="thumbnail">
                        <img src="../assets/slider/food3.png" alt="" />
                      </div>
                    </div>
          ...
          if ($result2->num_rows > 0) {
              ...
              while ($row = $result2->fetch_assoc()) {
                  ...
                  echo '<li>
                          ...
                          <div class="meta">
                            <div class="catrate">
                              <span class="cat"><a href="#">Baked</a></span>
                              <span class="rating">
...
?>
      ...
      <div class="modal_cart js-modal_cart">
        <div class="md_cart_container">
          <div class="md_cart_head">
            <div style="display: flex; gap: 10px">
              <i class="fa-solid fa-cart-shopping"></i>
              <h2>Your Cart</h2>
            </div>
            <i class="fa-solid fa-x md_cart_close"></i>
          </div>

          <div id="cartItem" class="md_box-cart-all"></div>
          <div id="total_money">
            Total:
