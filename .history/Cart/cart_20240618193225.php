      ...
      <main class="page">
        ...
        <div class="box-dashboard">
          ...
          <div class="box-dashboard-row"> 
            <p class="title-row">Tổng tiền <?php echo number_format($totalPrice, 2); ?></p>   
            <p class="caption-pay"><?php echo number_format($totalPrice, 2); ?></p>
          </div>
          <div class="box-dashboard-row"> 
            <p class="title-row">Nhập mã giảm giá</p>
            <div style="display: flex">
              <input class="discount" type="text" placeholder="Mã giảm giá" id="discountCode"></input>
        ...
        if (xhr.status === 200) {
            ...
            try {
                ...
                if (response.success) {
                    ...
                    document.querySelector('.caption-pay').innerHTML = "Tổng tiền: $" + discountedPrice.toFixed(2);
                } else {
