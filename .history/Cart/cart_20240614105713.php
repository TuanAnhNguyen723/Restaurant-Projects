...
<html lang="en">
    ...
    <main class="main-dashboard">
      ...
      <main class="page">
        ...
        <div class="box-dashboard">
          ...
          <?php echo "$" . number_format($discountedTotalPrice, 2); ?>
          </div>
          <div class="box-dashboard-row">
            <p class="title-row">Nhập mã giảm giá</p>
            <div style="display: flex">
              <input class="discount" type="text" id="discountCode" placeholder="Mã giảm giá">
              <button class="btn-apdung" onclick="applyDiscount()">Áp dụng</button>
            </div>
          </div>
  ...
  <script>
    ...
    // Submit the discount code via POST (modify as needed)
    var form = document.createElement("form");
    form.method = "POST";
    form.action = "<?php echo $_SERVER["PHP_SELF"]; ?>";  // Submit to current page
