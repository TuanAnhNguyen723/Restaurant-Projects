      ...
      <main class="page">
        ...
        <div class="box-dashboard">
          ...
          <div class="box-dashboard-row"> 
            ...
            <input class="discount" type="text" placeholder="Mã giảm giá" id="discountInput">
<button class="btn-apdung" id="applyButton">Áp dụng</button>
<p id="totalPrice"><?php echo "$" . number_format($totalPrice, 2); ?></p>
            </div>   
          </div>
